...
<div class="container-fluid anket">
    <h1 class="text-center"><fmt:message key="local.header.admin.teacher" bundle="${loc}"/></h1>
            ...
            <div class="row person-card">
                ...
                <div class="col-md-6 align-self-center">
                    <div class="qa-element">
                        ...
                        <p class="answer">
                            ${teacher.surname}
                            <c:if test="${teacher.surname == null}">
                                -
                            </c:if>
                        </p>
                    </div>
                    ...
                    <div class="qa-element">
                        ...
                        <p class="answer">
                            ${teacher.patronymic}
                            <c:if test="${teacher.patronymic==null}">
                                -
                            </c:if>
                        </p>
                    </div>
                    <div class="qa-element">
                        ...
                        <p class="answer">
                            ${teacher.position}
                            <c:if test="${teacher.position==null}">
                                -
                            </c:if>
                        </p>
                    </div>
