                    ...
                    <table class="table simulacion mx-auto">
                        <tr>
                            ...
                            <c:forEach var="work" items="${works}">
                                <th class="table-student">${work}</th>
                            </c:forEach>
                        </tr>
                        <tbody>
                        <c:set var="i" value="${1}"/>
                            ...
                            <tr>
                                <th scope="row">
                                    ...
                                    <i class="fa fa-ban" aria-hidden="true"
                                       ...
                                       onclick="location.href='${pageContext.request.contextPath}/mainController?command=${CommandVariety.SHOW_REJECT_APPLY_FORM}&student=${markElement.key.id}&course=${course.id}'"></i>
                                </th>
                                <td>
                                    <a href="#">
