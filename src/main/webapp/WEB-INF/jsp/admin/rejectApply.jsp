...
<body>
<div class="container">
    <div class="text-center form-name"><fmt:message key="local.header.reject.apply" bundle="${loc}"/></div>
    <div class="row">
        <div class="col-md-3"></div>
        <div class="col-md-6">
            <form method="post" action="mainController">
                <input type="hidden" name="command" value="${CommandVariety.REJECT_APPLY}">
                <input type="hidden" name="student" value="${student.id}">
                <input type="hidden" name="course" value="${course.id}">
                <div class="form-element">
                    <label><b><fmt:message key="local.student.name" bundle="${loc}"/>:</b> ${student.surname} ${student.name} ${student.patronymic}</label>
                </div>
                <div class="form-element">
                ...
                <div class="form-element">
                    ...
                    <textarea rows="7" name="review"></textarea>
                </div>
